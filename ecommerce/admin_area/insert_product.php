	...
	<form action="" method="post" enctype="multipart/form-data">
		<table align="center" width="800" border="2" bgcolor="blue">
			...
			<tr>
				...
				<td> 
				<textarea name="product_desc" cols="30" rows="10" placeholder="Description about the prroduct" ></textarea>
				</td>
			</tr><tr>
			...
			<tr>
				...
				<input type="submit" name="insert_post" value="Insert"  /></td>
			</tr>
...
<?php
	...
	if(isset($_POST['insert_post']))
	{
		...
		$insert_product_db= mysqli_query($con,$insert_product);
		if($insert_product_db)
		{
