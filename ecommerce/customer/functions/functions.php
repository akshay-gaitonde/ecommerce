...
function getCat_Pro()
{
	...
	if($count_pro==0){echo"<h2>No product found in this cateogory</h2>";}
...
function getBrand_Pro()
{
	...
	if($count_pro==0){echo"<h2>No product found in  brand</h2>";}
